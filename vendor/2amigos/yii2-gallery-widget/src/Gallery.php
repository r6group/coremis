...
class Gallery extends Widget
{
     ...
     */
    public function renderItem($i, $item)
    {
        if (is_string($item)) {
            return Html::a(Html::img($item), $item, ['class' => 'img-responsive gallery-item']);
        }
        ...
        Html::addCssClass($options, 'img-responsive gallery-item');
