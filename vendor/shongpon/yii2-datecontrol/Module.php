...
class Module extends \yii\base\Module
{
     ...
     * - \shongpon\date\DatePicker for Module::FORMAT_DATE
     * - \shongpon\time\TimePicker for Module::FORMAT_TIME
     * - \shongpon\datetime\DateTimePicker for Module::FORMAT_DATETIME
     ...
     * - `$settings`: array, the widget settings for the shongpon\widgets based on the type.
     * @see `Module::initSettings()`
     */
     ...
     *
     * @see https://github.com/shongpon-v/php-date-formatter
     */
    ...
    /**
     * Gets the default options for the `\shongpon\widgets` based on `type`
     *
     * @param string $type
     * @param string $format
     * @return array
