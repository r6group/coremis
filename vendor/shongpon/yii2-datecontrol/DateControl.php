 ...
 * @since 1.0
 */
class DateControl extends \shongpon\base\InputWidget
{
    ...
    /**
     * @var bool whether to automatically use \shongpon\widgets based on `$type`. Will use these widgets:
     * - \shongpon\date\DatePicker for FORMAT_DATE
     * - \shongpon\time\TimePicker for FORMAT_TIME
     * - \shongpon\datetime\DateTimePicker for FORMAT_DATETIME
     ...
     * For example when using this widget as a filter in \shongpon\grid\GridView.
     */
    ...
    /**
     * @var \shongpon\datecontrol\Module the `datecontrol` module instance
     */
    protected $_module;
    ...
    protected function initConfig()
    {
        ...
        if ($this->autoWidget) {
            $this->_widgetSettings = [
                self::FORMAT_DATE => ['class' => '\shongpon\date\DatePicker'],
                self::FORMAT_DATETIME => ['class' => '\shongpon\datetime\DateTimePicker'],
                self::FORMAT_TIME => ['class' => '\shongpon\time\TimePicker'],
            ];
