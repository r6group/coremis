...
1. (enh #14, #15): Revamped and enhanced datecontrol plugin to work with the [php-date-formatter.js](https://github.com/shongpon-v/php-date-formatter) jQuery plugin.
...
4. (enh #9): Included `autoWidgetSettings` in module, for configuring global settings for `shongpon\widgets` when `autoWidget` is true.
