...
[![Latest Stable Version](https://poser.pugx.org/shongpon-v/yii2-datecontrol/v/stable)](https://packagist.org/packages/shongpon-v/yii2-datecontrol)
[![License](https://poser.pugx.org/shongpon-v/yii2-datecontrol/license)](https://packagist.org/packages/shongpon-v/yii2-datecontrol)
[![Total Downloads](https://poser.pugx.org/shongpon-v/yii2-datecontrol/downloads)](https://packagist.org/packages/shongpon-v/yii2-datecontrol)
[![Monthly Downloads](https://poser.pugx.org/shongpon-v/yii2-datecontrol/d/monthly)](https://packagist.org/packages/shongpon-v/yii2-datecontrol)
[![Daily Downloads](https://poser.pugx.org/shongpon-v/yii2-datecontrol/d/daily)](https://packagist.org/packages/shongpon-v/yii2-datecontrol)
...
> Version 1.9.3 has been released. Refer [CHANGE LOG](https://github.com/shongpon-v/yii2-datecontrol/blob/master/CHANGE.md) for details.
...
- [\shongpon\widgets\DatePicker](http://demos.krajee.com/widget-details/datepicker) or [\shongpon\date\DatePicker](http://demos.krajee.com/widget-details/datepicker) if your format type is `date`
- [\shongpon\widgets\TimePicker](http://demos.krajee.com/widget-details/timepicker) or [\shongpon\time\TimePicker](http://demos.krajee.com/widget-details/timepicker)if your format type is `time`
- [\shongpon\widgets\DateTimePicker](http://demos.krajee.com/widget-details/datetimepicker) or [\shongpon\time\DateTimePicker](http://demos.krajee.com/widget-details/datetimepicker) if your format type is `datetime`
...
```php
use shongpon\datecontrol\Module;
'modules' => [
   'datecontrol' =>  [
        'class' => 'shongpon\datecontrol\Module',
        ...
        // automatically use shongpon\widgets for each of the above formats
        'autoWidget' => true,
        
        // use ajax conversion for processing dates from display format to save format.
        'ajaxConversion' => true,

        // default settings for each widget from shongpon\widgets used when autoWidget is true
        'autoWidgetSettings' => [
        ...
        // custom widget settings that will be used to render the date input instead of shongpon\widgets,
...
at the widget level. An usage example with `ActiveForm` and using `\shongpon\widgets\DateTimePicker` is shown below. Note you can pass date-time
...
> Note: Check the [composer.json](https://github.com/shongpon-v/yii2-datecontrol/blob/master/composer.json) for this extension's requirements and dependencies.
Read this [web tip /wiki](http://webtips.krajee.com/setting-composer-minimum-stability-application/) on setting the `minimum-stability` settings for your application's composer.json.

Either run

```
$ php composer.phar require shongpon-v/yii2-datecontrol "@dev"
```

or add

```
"shongpon-v/yii2-datecontrol": "@dev"
```
...
```php
use shongpon\datecontrol\Module;
use shongpon\datecontrol\DateControl;
```
