 ...
 */
class DatePicker extends \shongpon\base\InputWidget
{
    ...
    public function init()
    {
        ...
        $this->options['data-provide'] = "datepicker";
        $this->options['data-date-language'] = "th-th";
        $this->options['data-date-format'] = "d MM yyyy";
        $this->options['data-date-autoclose'] = "true";
        $this->options['data-date-today-highlight'] = "true";
    ...
    public function registerAssets()
    {
        ...
        if ($this->type === self::TYPE_RANGE) {
            \shongpon\field\FieldRangeAsset::register($view);
