var EcommerceProductsEdit = function () {
    ...
    var handleImages = function() {
        ...
        var uploader = new plupload.Uploader({
            ...
            url : "theme/plugins/plupload/examples/upload.php",
            ...
            // Flash settings
            flash_swf_url : 'theme/plugins/plupload/js/Moxie.swf',
     
            // Silverlight settings
            silverlight_xap_url : 'theme/plugins/plupload/js/Moxie.xap',
    ...
    var handleReviews = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                // setup uses scrollable div(table-scrollable) with overflow:auto to enable vertical scroll(see: theme/global/scripts/datatable.js).
