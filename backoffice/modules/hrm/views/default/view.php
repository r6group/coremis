...
<div class="row profile-wrapper">
    <div class="col-xs-12 col-md-3 col-lg-2 profile-left mb20">
        <div class="profile-left-heading">
            ...
            <ul class="list-group">
                <li class="list-group-item"><i class="glyphicon glyphicon-briefcase mr5"></i> <?=\common\models\CHospital::getHospitalName($model->off_id)?></li>
...
//                        ],
                ...
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'attribute' => 'off_id',
                            'value' => $model->off_id . ' ' .CHospital::getHospitalName($model->off_id)
                        ],
                        [
                            'attribute' => 'off_id18',
                            'value' => $model->off_id18 . ' ' .CHospital::getHospitalName($model->off_id18)
                        ],
                        [
                            'attribute' => 'stf_type',
