    ...
    <div class="col-md-9 col-lg-8 dash-left">
        <div class="panel panel-announcement">
            ...
            <div class="panel-body">
                <h2>A new admin template has been released by <span class="text-primary">ThemePixels</span> with a name
                    <span class="text-success">Quirk</span> is now live and available for purchase!</h2>
        ...
        <div class="row panel-quick-page">
            <div class="col-xs-4 col-sm-5 col-md-4 page-user">
                ...
                <div class="panel">
                    <a href="<?= Url::toRoute('hrm/default/index') ?>">
                        <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-7 col-lg-8">
                                ...
                                <div class="progress">
                                    <div style="width: 75.7%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75.7"
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-7 col-lg-8">
                                ...
                                <div class="progress">
                                    <div style="width: 39.9%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="39.9"
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-7 col-lg-8">
                                ...
                                <div class="progress">
                                    <div style="width: 55.4%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="55.4"
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-7 col-lg-8">
                                ...
                                <div class="progress">
                                    <div style="width: 22.1%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="22.1"
            ...
            <div class="col-sm-6 col-md-12 col-lg-6">
                ...
                <div class="panel panel-danger panel-weather">
                    ...
                    <div class="panel-body inverse">
                        <div class="row mb10">
                            <div class="col-xs-6">
                                <h2 class="today-day">วัน<?= $TH_Day[$nDay]; ?></h2>

                                <h3 class="today-date"><?= $date ?> <?= $TH_Month[$nMonth] ?> <?= $year ?></h3>
                            </div>
                            <div class="col-xs-6" style="text-align: center">

                                <img id="big" src="" alt="" style="width: 100%;max-width: 120px">
                            </div>
                        </div>
                        <p class="nomargin">

                        <h3 id="condition-text" class="today-day" style="color: #fff"></h3>
                        ...
                        <div class="row mt10">
                            <div class="col-xs-6">
                                <strong>อุณหภูมิ:</strong> <span id="deg"></span>
                            </div>
                            <div class="col-xs-6">
                                <strong>ความเร็วลม:</strong> <span id="wind"></span> <span id="speed-unit"></span>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-xs-3 col-sm-3" style="text-align: center">
                                <h4 class="nomargin" id="forecast0" style="color: #fff">-</h4>
                                <hr class="nomargin">
                                <img id="forecastimg0" src="" style="width: 100%;max-width: 80px"></img>
                                <h5 class="text-success" id="forecastdeg0">-</h5>
                            </div>
                            <div class="col-xs-3 col-sm-3" style="text-align: center">
                                <h4 class="nomargin" id="forecast1" style="color: #fff">-</h4>
                                <hr class="nomargin">
                                <img id="forecastimg1" src="" style="width: 100%;max-width: 80px"></img>
                                <h5 class="text-success" id="forecastdeg1">-</h5>
                            </div>
                            <div class="col-xs-3 col-sm-3" style="text-align: center">
                                <h4 class="nomargin" id="forecast2" style="color: #fff">-</h4>
                                <hr class="nomargin">
                                <img id="forecastimg2" src="" style="width: 100%;max-width: 80px"></img>
                                <h5 class="text-success" id="forecastdeg2">-</h5>
                            </div>
                            <div class="col-xs-3 col-sm-3" style="text-align: center">
                                <h4 class="nomargin" id="forecast3" style="color: #fff">-</h4>
                                <hr class="nomargin">
                                <img id="forecastimg3" src="" style="width: 100%;max-width: 80px"></img>
                                <h5 class="text-success" id="forecastdeg3">-</h5>
                            </div>
                        ...
                        <ul class="media-list user-list">
                                ...
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object img-circle"
                                             src="<?php echo $this->theme->baseUrl ?>/images/photos/user2.png" alt="">
                                    </a>
                                </div>
                            ...
                            <li class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object img-circle"
                                             src="<?php echo $this->theme->baseUrl ?>/images/photos/user10.png" alt="">
                                    </a>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object img-circle"
                                             src="<?php echo $this->theme->baseUrl ?>/images/photos/user3.png" alt="">
                                    </a>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object img-circle"
                                             src="<?php echo $this->theme->baseUrl ?>/images/photos/user5.png" alt="">
                                    </a>
                                </div>
                                <div class="media-body">
                        ...
                        <ul class="media-list user-list">
                            <li class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object img-circle"
                                             src="<?php echo $this->theme->baseUrl ?>/images/photos/user9.png" alt="">
                                    </a>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object img-circle"
                                             src="<?php echo $this->theme->baseUrl ?>/images/photos/user4.png" alt="">
                                    </a>
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object img-circle"
                                             src="<?php echo $this->theme->baseUrl ?>/images/photos/user6.png" alt="">
                                    </a>
                                </div>
                                <div class="media-body">
