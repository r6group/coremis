...
<div class="panel signin">
    <div class="panel-heading" style="text-align: center">
        <a href="<?= Yii::$app->homeUrl; ?>"><img src="<?=Url::to('@web/themes/quirk/images/mipble_logo.png')?>" style="max-width: 200px"> </a>
        <h4 class="panel-title">ยินดีต้อนรับ! กรุณาลงชื่อเข้าใช้.</h4>
    </div>
    <div class="panel-body">
        <button class="btn btn-primary btn-quirk btn-fb btn-block">Login ด้วย Facebook</button>
        <div class="or">or</div>
