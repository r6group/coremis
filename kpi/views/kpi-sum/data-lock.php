...
$this->title = 'This page is temporarily unavailable';
?>
    ...
    <div class="inner-page">
        <h1>
				<span class="clearfix title">
					<span class="number">( ^_^)</span> <span class="text">Oops! <br/>Sorry.</span>
				</span>
        </h1>
        <p>ขออภัย. ระงับการบันทึกข้อมูลชั่วคราว, please <a href="<?=Url::toRoute(['site/contact'])?>">contact us</a> to report this issue.</p>
