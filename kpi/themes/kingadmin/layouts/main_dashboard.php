...
<!--                    <div style="overflow: scroll; height: 90%;">-->
                        ...
                        <nav class="main-nav">
                            ...
                            $kpi_group = \Yii::$app->request->getQueryParam('kpi_group');


                            if (!function_exists('getChildKpi'))   {
                                function getChildKpi($kpi_id, $param_id, $class, $kpi_group)  {
                                    $kpi_group = \Yii::$app->request->getQueryParam('kpi_group');
                                    $result = '';
...
ORDER BY l.kpi_no";
                                    ...
                                    for ($i = 0; $i < sizeof($kpi); $i++) {
                                        ...
                                        if ($operator == "=") {
                                            ...
                                            $result .= '  <a href="'. Yii::$app->urlManager->createUrl(['kpi/index', 'id' => $kpi[$i]['id'], 'kpi_group' => $kpi_group]).'">';
...
AND l.my_kpi = 1 AND l.parent_id = 0 AND l.my_kpi_group = ".$kpi_group."
GROUP BY l.id
ORDER BY l.kpi_no";
...
//                                            }
                                        ...
                                        if ($kpi[$i]['parent_id'] != null) {
                                            ...
                                            echo getChildKpi($kpi[$i]['id'], $param_id, isset($this->params['sidemenu']) ? $this->params['sidemenu'] : null,  $kpi_group);
							                echo '</ul></li>';
                                            ...
                                            <li<?= $active ?>>
                                                ...
                                                <a href="<?= Yii::$app->urlManager->createUrl(['kpi/index', 'id' => $kpi[$i]['id'], 'kpi_group' => $kpi_group]) ?>">
